	...
	<Flex direction="column" gap="24" :class="$style.container">
		...
		<Flex direction="column" gap="8">
			...
			<Text size="13" color="tertiary">
				{{
					verificationStore.verificationMethod === 'sourcify'
						? 'Upload all contract source files including metadata.json from Hardhat/Foundry'
						: isStandardJson
							? 'Provide the Standard JSON input'
							: 'Upload or paste your contract source code'
				}}
			</Text>
		</Flex>

		<!-- Sourcify Info Banner -->
		<Flex
			v-if="verificationStore.verificationMethod === 'sourcify'"
			direction="column"
			gap="8"
			:class="$style.sourcifyBanner"
		>
			<Flex align="center" gap="8">
				<Icon name="info" size="14" color="blue" />
				<Text size="12" weight="600" color="primary">Sourcify Verification</Text>
			</Flex>
			<Text size="11" color="tertiary">
				Sourcify automatically extracts compiler version, optimization settings, and other metadata from your metadata.json file.
				Simply upload all your contract source files including the metadata.json generated by Hardhat or Foundry.
			</Text>
		</Flex>
